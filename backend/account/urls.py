...
from .views import ChangePasswordView, DeleteUser, EmailVerification, Login, Logout, Register, RequestPasswordResetEmail, SendEmailVerification, SetNewPasswordAPIView
